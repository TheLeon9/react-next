...
export default function Index() {
  ...
  return (
    <div className={style.mission_company_cont}>
      ...
      <div className={style.new_mission_cont}>
        <Link href="/company/mission/create" className="btn btn_primary">
      ...
      <div className={style.card_cont}>
        <div className={style.card}>
          ...
          <div className={style.button_cont}>
            <Link href="/company/mission/update" className="btn btn_primary">
              UPDATE
            </Link>
            <button
